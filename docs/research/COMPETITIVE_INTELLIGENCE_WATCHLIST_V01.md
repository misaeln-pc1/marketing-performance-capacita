# Competitive Intelligence Watchlist V01

Estado: `DRAFT_NO_VIGENTE`

## Propósito

Mantener un radar liviano de organizaciones que puedan ser competidores, referentes funcionales o referentes aspiracionales útiles para benchmarking de Marketing Capacita.

La inclusión en esta lista **no implica** que una organización sea comparable 1:1 con Capacita ni que sus prácticas deban copiarse. Cada caso debe validarse según curso, modalidad, buyer persona, mercado y objetivo del análisis.
...
- `COMPETIDOR_DIRECTO`: disputa una oferta, cliente, modalidad o intención comercial suficientemente equivalente.
- `COMPETIDOR_PARCIAL`: coincide sólo en parte del portafolio, segmento, modalidad o mercado.
- `REFERENTE_FUNCIONAL`: posee una práctica concreta que vale la pena estudiar o adaptar.
- `REFERENTE_ASPIRACIONAL`: representa un nivel de escala, madurez, marca, operación o posicionamiento al que Capacita podría querer acercarse.
- `PARTNER_PROVEEDOR_CANDIDATO`: podría complementar capacidades de Capacita mediante servicios, tecnología, contenidos o ejecución especializada.
- `NO_COMPARABLE`: puede aportar contexto, pero no debe usarse como benchmark operativo directo.
...
- `https://grado45.cl/`
- `https://grado45.cl/servicios-y-productos/`
- `https://grado45.cl/quienes-somos/`
- `https://grado45.cl/sinmiedoalclic/`

### Edutecno

- `https://edutecno.cl/`
- `https://edutecno.cl/cursos/`
- `https://edutecno.cl/conocenos/`
- `https://edutecno.cl/tde/`
- `https://edutecno.cl/blog/`
- `https://edutecno.cl/prensa/`
- `https://edutecno.cl/descarga-ebook-inteligencia-artificial/`
- `https://adamuch.edutecno.cl/`

Fecha de revisión preliminar: 2026-08-29.
