...
Fecha: 2026-07-29  
Estado: `PROCEDIMIENTO_OPERATIVO_VALIDADO_EN_CHAT`  
...
```text
Ads Manager -> selector de cuenta publicitaria -> Otros activos -> cuenta publicitaria activa con campañas historicas
```
...
+ permiso ads_read
+ cuenta publicitaria activa bajo Otros activos
...
Usar el `act_...` completo solo en entorno local o privado. En GitHub registrar solo referencia sanitizada.
...
## 8. Export local obligatorio

Los resultados crudos deben guardarse fuera del repo, por ejemplo:
...
META_ACCESS_TOKEN=<NO_VERSIONAR>
