...
| 20260728-174500 | Marketing Performance | Capacita Edge | `EXCEL_B2C_PAID_LANDINGS_REVIEW_RESPONSE` | v02 | `READY` | `docs/xfer/XFER__MARKETING__CAPACITA_EDGE__EXCEL_B2C_PAID_LANDINGS_REVIEW_RESPONSE__20260728-174500__v02__READY__LANDING_REVIEW_REQUEST.md` | `CONSUMED_WITH_CHANGES` para XFER Edge v05; requiere respuesta Edge. |
