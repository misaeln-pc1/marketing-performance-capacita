...
| 2026-08-14 | Mantener Google Ads API/PowerShell read-only como `METHOD_A` y fallback validado. Evaluar el Google Ads MCP oficial sólo mediante micro-piloto de paridad por tarea; no migrar sin ganancia material demostrada. | Google Ads / conectividad analítica | Amarillo | `docs/analytics/CONNECTED_MARKETING_ANALYTICS_PILOT_2026-08-14.md` |
| 2026-08-14 | Adoptar `ADAPTAR_MINIMO` para Google account diagnostics, Anthropic performance-report y Anthropic competitive-brief. Esta decisión reusable no cambia lifecycle ni declara skills `approved`. | Skills / AI OS | Amarillo | `SKILLS_USED.md`; AI OS PR #41 |
| 2026-08-14 | Separar obligatoriamente conversión de plataforma, señal GA4, Lead/Contact, Deal, CursoAlumno y venta real. Un `DATA_GAP` no se rellena por inferencia; el join debe declarar nivel de confianza. | Atribución cross-source | Amarillo | `docs/analytics/CONNECTED_MARKETING_ANALYTICS_PILOT_2026-08-14.md` |
| 2026-08-14 | Mantener Meta API `ads_read` y routing canónico como fallback. El conector/agente oficial Meta sólo se pilota en read-only si ya está disponible/autenticado y aporta ganancia material. | Meta Ads / conectividad analítica | Amarillo | `docs/analytics/CONNECTED_MARKETING_ANALYTICS_PILOT_2026-08-14.md`; `docs/meta-ads/META_ADS_ACCOUNT_ROUTING.md` |
| 2026-08-14 | Definir Excel B2C presencial Santiago como primer piloto E2E por concentración de evidencia. No declarar ganador comercial mientras GA4, mapping CRM, Deal, CursoAlumno o venta real sigan `DATA_GAP`. | Piloto de negocio | Amarillo | `docs/analytics/CONNECTED_MARKETING_ANALYTICS_PILOT_2026-08-14.md` |
...
- Para analytics conectado, preservar fallback actual y exigir paridad + ganancia material antes de migrar una tarea a MCP/conector.
- Para atribución, una conversión de plataforma nunca equivale por sí sola a lead, Deal, CursoAlumno o venta real.
