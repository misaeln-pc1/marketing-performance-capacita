...
| 2026-07-12 | Conservar la página orgánica actual indexable y con cambios sólo operativos mínimos. Crear dos landings nuevas de tráfico pagado configuradas inicialmente con `noindex,follow`: una Básico–Intermedio orientada a `BP-001` y otra Excel Básico desde cero orientada a `BP-002`. No crear tres o cuatro landings en esta fase ni mezclar Excel Avanzado con esta oferta. Esta decisión reemplaza la alternativa anterior de dos páginas nuevas indexables. | SEO, paid media, buyer persona y landings | Amarillo | `docs/search-console/SEARCH_CONSOLE_API_SCOPE_AND_PAID_LANDING_DECISION_V01.md` |
