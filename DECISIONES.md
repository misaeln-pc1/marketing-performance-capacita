...
| 2026-07-12 | Adoptar una arquitectura B2C de dos páginas indexables para un mismo curso real: página actual orientada a `Excel presencial / Básico e Intermedio` y página nueva orientada a `Excel Básico / desde cero`. No crear página intermedia ni de clases particulares en esta fase. | SEO, landings y Google Ads | Amarillo | `docs/landing-pages/EXCEL_B2C_TWO_PAGE_PLAN_AND_CRO_BASELINE_2026-07-12.md` |
| 2026-07-12 | No exigir un porcentaje artificial de diferencia textual. Las páginas deben diferenciarse por intención, promesa, objeciones, jerarquía, FAQ y valor útil; pueden compartir producto, precio, fechas, sede, imágenes, temario y formulario. Resolver la URL histórica antes de publicar. | SEO y prevención de canibalización | Amarillo | Baseline de dos páginas B2C |
