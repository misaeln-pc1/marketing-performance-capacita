...
| 2026-07-12 | Conservar la página orgánica actual indexable y con cambios sólo operativos mínimos. Crear tres landings nuevas de tráfico pagado configuradas inicialmente con `noindex,follow`: Básico–Intermedio orientada a `BP-001`; Excel Básico desde cero orientada a `BP-002`; y clases presenciales con profesor orientada a `BP-001`. No mezclar Excel Avanzado con esta oferta. Esta decisión reemplaza el alcance previo de dos landings pagadas. | SEO, paid media, buyer persona y landings | Amarillo | `docs/handoffs/HANDOFF_EXCEL_PAID_LANDINGS_SEARCH_CONSOLE_2026-07-12.md` |
| 2026-07-12 | La tercera landing es una prueba reversible para personas que buscan clases presenciales, profesor en vivo o una alternativa estructurada frente a clases particulares. Debe declarar que se trata de un curso grupal Básico–Intermedio en sede; no puede prometer clases particulares, uno a uno, profesor exclusivo ni atención a domicilio. | Mensaje, intención, Google Search y control de claims | Amarillo | Handoff de landings pagadas; aprobación de Misael |
| 2026-07-12 | No exigir un porcentaje artificial de diferencia textual. Las landings pagadas deben diferenciarse por intención, buyer persona, promesa, objeciones, jerarquía, FAQ y CTA; pueden compartir producto, precio, fechas, sede, imágenes, temario y formulario. | Diseño de landing y experimentación | Amarillo | Baseline CRO y briefs BP-001/BP-002 |
| 2026-07-12 | Retirar la guía gratuita como promesa principal del hero pagado. PageSense confirma fricción de formulario y que los goals actuales miden clics, no submits. La descarga de temario queda como conversión secundaria. | CRO, CTA y medición | Amarillo | Baseline PageSense y auditoría de goals |
| 2026-07-12 | Excluir SENCE, beneficio tributario, franquicia tributaria y gratuidad de toda comunicación B2C. En B2B, tratarlos sólo en rutas específicas y con cautela para no atraer intención de cursos gratis. | Mensaje, keywords y negativas | Amarillo | Evidencia histórica del usuario; baseline de landings |
| 2026-07-12 | La hipótesis Turnstile no explica el formulario B2C vigente porque esa landing envía directo a Zoho y no usa Turnstile. Auditar Turnstile sólo en landings que usan `/api/forms/lead`, mediante Analytics y errores sanitizados del backend. | Tracking y seguridad técnica | Amarillo | Baseline de landings B2C; Edge `FORM_FLOW_ARCHITECTURE.md` |
| 2026-07-12 | Implementar una línea read-only separada de Search Console API para consultas, páginas, clics, impresiones, CTR y posición orgánica. Google Ads API continúa como fuente de campañas, términos pagados, gasto, CPC y Keyword Planner. No asumir que una API reemplaza a la otra. | SEO, reporting y APIs | Amarillo | `docs/search-console/SEARCH_CONSOLE_API_SCOPE_AND_PAID_LANDING_DECISION_V01.md` |
| 2026-07-12 | Las tres landings pagadas deben tener medición independiente y reconciliable: URL, `landing_code`, UTM, variante, intención, buyer persona como hipótesis, funnel PageSense/GA4/GTM y resultado Zoho. No inventar API names ni tratar clics como submits. | Tracking, CRM y aprendizaje experimental | Amarillo | Handoff de landings pagadas; Edge #27 |
