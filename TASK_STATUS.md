...
TECH_REPORT_FOLLOWUP=PERIODIC_RECHECK
META_RESPONSE=NO_INDIVIDUAL_RESPONSE_EXPECTED
ADS_WRITES=0
PAYMENT_WRITES=0
...
## Incidente Meta/Facebook — anti-bucle vigente 2026-09-20

Issue canónico:

`#108 — [INCIDENTE][META] Perfil Facebook restringido + bucle advanced_protection`

Leer antes de pedir nuevas acciones a Misael:

```text
1. issue #108
2. docs/incidents/META_FACEBOOK_RESTRICTED_ADVANCED_PROTECTION_LOOP_2026-09-19.md
3. docs/incidents/META_FACEBOOK_ADVANCED_PROTECTION_EXTERNAL_RESEARCH_2026-09-20.md
4. docs/meta-ads/META_ADS_ACCOUNT_ROUTING.md
```
...
PROFILE_STATUS=RESTRICTED
PASSKEY_AUTH=PASS
CHECKPOINT_ADVANCED_PROTECTION=FAIL_ERR_TOO_MANY_REDIRECTS
INSTAGRAM=PASS
THREADS=PASS
ADVANCED_PROTECTION_CONTROL_IN_IG=NOT_EXPOSED
META_VERIFIED_ENTRY=ALREADY_FOUND
BUSINESS_STANDARD=ALREADY_REVIEWED
BUSINESS_PLUS=ALREADY_REVIEWED
TECH_REPORT_SENT=YES_NO_PERSONAL_REPLY
PAID_SUPPORT_FLOW=BLOCKED_BY_FACEBOOK_AUTH_LOOP
OTHER_ADMIN_2327=NOT_VERIFIED
...
NO_REPEAT_INCOGNITO
NO_REPEAT_2FA_RESET
NO_REPEAT_PASSKEY_CREATION
NO_REPEAT_DEVICE_REMOVAL
NO_REPEAT_META_VERIFIED_LOCATION_SEARCH
NO_REPEAT_BUSINESS_STANDARD_PLUS_DISCOVERY
NO_REPEAT_INSTAGRAM_ADVANCED_PROTECTION_SEARCH
NO_REPEAT_TECH_REPORT_EXPECTATION
```

Sólo repetir una ruta con evidencia nueva objetiva.
